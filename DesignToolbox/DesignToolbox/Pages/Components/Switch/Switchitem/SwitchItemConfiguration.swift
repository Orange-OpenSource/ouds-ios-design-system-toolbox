...
struct SwitchItemConfiguration: View {
    ...
    @ObservedObject var configurationModel: SwitchItemConfigurationModel
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: theme.spaces.spaceFixedMedium) {
            VStack(alignment: .leading, spacing: theme.spaces.spaceFixedNone) {
                OUDSSwitchItem("app_components_switch_selection_label", isOn: $configurationModel.selection)
