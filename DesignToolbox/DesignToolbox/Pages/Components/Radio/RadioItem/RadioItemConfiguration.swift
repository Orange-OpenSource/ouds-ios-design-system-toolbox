...
struct RadioItemConfiguration: View {
    ...
    @ObservedObject var configurationModel: RadioItemConfigurationModel
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: theme.spaces.spaceFixedMedium) {
            VStack(alignment: .leading, spacing: theme.spaces.spaceFixedNone) {
                OUDSSwitchItem("app_components_radioButton_selection_label", isOn: $configurationModel.selection)
                ...
                OUDSSwitchItem("app_components_radioButton_radioButtonItem_outlined_label", isOn: $configurationModel.outlined)
