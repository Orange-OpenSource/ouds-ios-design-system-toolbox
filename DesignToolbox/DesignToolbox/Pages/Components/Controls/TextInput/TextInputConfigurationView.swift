...
// MARK: - Extension of OUDSTextInput.Placeholder
        ...
        VStack(alignment: .leading, spacing: theme.spaces.spaceFixedMd) {
            VStack(alignment: .leading, spacing: theme.spaces.spaceFixedNone) {
                OUDSSwitchItem("app_components_common_outlined_label", isOn: $configurationModel.isOutlined)
                    .accessibilityIdentifier(A11YIdentifiers.configurationSwitchOutlined)

                OUDSSwitchItem("app_components_textInput_leadingIcon_label", isOn: $configurationModel.leadingIcon)
                    .accessibilityIdentifier(A11YIdentifiers.configurationSwitchLeadingIcon)

                OUDSSwitchItem("app_components_controlItem_flipIcon_label", isOn: $configurationModel.flipLeadingIcon)
