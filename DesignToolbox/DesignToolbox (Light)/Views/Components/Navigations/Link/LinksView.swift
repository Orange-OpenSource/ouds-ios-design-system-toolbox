...
struct LinksView: View {
    ...
    private var watchOSVerticalLayout: some View {
        WatchVerticalLayout {
            ...
            OUDSLink(text: "Link", icon: OUDSImage(asset: Image(systemName: "sun.min.fill")), size: .default) {}
            ...
            OUDSLink(text: "Link", icon: OUDSImage(asset: Image(systemName: "sun.min.fill")), size: .small) {}.disabled(true)
            ...
            OUDSLink(text: "Link", icon: OUDSImage(asset: Image(systemName: "sun.min.fill")), size: .small) {}
    ...
    private var tvOSGridLayout: some View {
        TVGridLayout(count: 4) {
            ...
            VStack(spacing: theme.spaces.paddingBlockLarge) {
                ...
                linkSection(title: "Default Size") {
                    OUDSLink(text: "Link", icon: OUDSImage(asset: Image(systemName: "sun.min.fill")), size: .default) {}
                    OUDSLink(text: "Link", icon: OUDSImage(asset: Image(systemName: "sun.min.fill")), size: .default) {}.disabled(true)
                }
