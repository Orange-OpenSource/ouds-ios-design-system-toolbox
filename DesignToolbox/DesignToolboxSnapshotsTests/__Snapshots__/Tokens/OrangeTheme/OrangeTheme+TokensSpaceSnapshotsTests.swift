...
final class OrangeThemeTokensSpaceSnapshotsTests: TokensSpaceSnapshotsTestsTestCase {
    ...
    /// This function tests all _ tokens in the `OrangeTheme` with  the `light` color schemes.
