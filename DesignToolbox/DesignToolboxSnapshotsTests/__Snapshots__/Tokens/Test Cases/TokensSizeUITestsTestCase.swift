...
open class TokensSizeUITestsTestCase: XCTestCase {
    ...
    @MainActor func testSizeIconDecorative(for theme: OUDSTheme, in interfaceStyle: UIUserInterfaceStyle) {
    ...
    ///   - theme: Theme used for rendering tokens (e.g., `OrangeTheme`).
    ///   - interfaceStyle: The user interface style (light or dark) for which to test the colors.
    @MainActor func testSizeIconWithTypography(for theme: OUDSTheme, in interfaceStyle: UIUserInterfaceStyle) {
