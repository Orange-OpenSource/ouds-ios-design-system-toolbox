...
/// Tests the UI rendering of each **space token** using reference images for `OrangeCompactTheme`
final class OrangeCompactThemeTokensSpaceSnapshotsTests: TokensSpaceSnapshotsTestsTestCase {
    ...
    /// This function tests all _ tokens in the `OrangeCompactTheme` with  the `light` color schemes.
    ...
    @MainActor func testAllSpacesOrangeCompactThemeLight() {
    ...
    /// This function tests all space tokens in the `OrangeCompactTheme` with both the  `dark` color schemes.
    ...
    @MainActor func testAllSpacesOrangeCompactThemeDark() {
