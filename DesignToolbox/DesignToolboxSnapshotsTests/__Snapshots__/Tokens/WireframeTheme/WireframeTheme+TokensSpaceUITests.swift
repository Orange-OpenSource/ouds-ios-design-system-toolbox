...
final class WireframeThemeTokensSpaceUITests: TokensSpaceUITestsTestCase {
    ...
    /// This function tests all dimension tokens in the `WireframeTheme` with  the `light` color schemes.
