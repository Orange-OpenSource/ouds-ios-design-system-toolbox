...
/// is in the management of the states. Uses `OrangeCompactTheme`.
final class OrangeCompactThemeCheckboxSnapshotsTests: CheckboxSnapshotsTestsTestCase {
    ...
    @MainActor func testAllCheckboxesOrangeCompactThemeLight() {
    ...
    @MainActor func testAllCheckboxesOrangeCompactThemeDark() {
