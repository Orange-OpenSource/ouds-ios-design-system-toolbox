...
/// is in the management of the states. Uses `WireframeTheme`.
final class WireframeThemeCheckboxSnapshotsTests: CheckboxSnapshotsTestsTestCase {
    ...
    @MainActor func testAllCheckboxesWireframeThemeLight() {
    ...
    @MainActor func testAllCheckboxesWireframeThemeDark() {
