...
/// is in the management of the states. Uses `OrangeInverseTheme`.
final class OrangeInverseThemeCheckboxUITests: CheckboxUITestsTestCase {
    ...
    @MainActor func testAllCheckboxesOrangeInverseThemeLight() {
    ...
    @MainActor func testAllCheckboxesOrangeInverseThemeDark() {
