...
/// Tests the UI rendering of the `OUDSSwitch` and `OUDSSwitchItem` for each parameter  for `OrangeInverseTheme`.
final class OrangeInverseThemeSwitchUITests: SwitchUITestsTestCase {
    ...
    @MainActor func testAllSwitchesOrangeInverseThemeLight() {
    ...
    @MainActor func testAllSwitchesOrangeInverseThemeDark() {
