...
/// Tests the UI rendering of the `OUDSBadgeStandard`, `OUDSBadgeIcon` and `OUDSBadgeCount` components for each parameter with `OrangeTheme`
final class OrangeThemeBadgeSnapshotsTests: BadgeSnapshotsTestsTestCase {
