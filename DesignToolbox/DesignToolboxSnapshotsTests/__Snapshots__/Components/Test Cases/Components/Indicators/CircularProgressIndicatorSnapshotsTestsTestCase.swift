...
/// Tests the UI rendering of the `OUDSCircularProgressIndicator` for each parameter.
///
...
open class CircularProgressIndicatorSnapshotsTestsTestCase: XCTestCase {
    ...
    {
        for status in OUDSCircularProgressIndicator.Status.allCases {
            for gapSize in OUDSCircularProgressIndicator.GapSize.allCases {
    ...
    /// Renders a single determinate `OUDSCircularProgressIndicator` in the given configuration and
    ...
    @MainActor func testCircularProgressIndicator(theme: OUDSTheme,
                                                  interfaceStyle: UIUserInterfaceStyle,
